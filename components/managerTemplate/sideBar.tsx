...
h-6 text-black"
            >
              <path
                ...
                d="M3.75 5.25h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5m
16.5 4.5h16.5"
              />
            </svg>
          </button>
...
fixed top-0 right-full transition-transform z-50 
           bg-cyan-300 border-r border-primary ${
...
500"
        ...
        {/* user section */}
        <div
          className="w-full mt-10 mb-6 bg-primary text-neutral-950 p-3 
